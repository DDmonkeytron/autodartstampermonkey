...
(() => {
  ...
  const DEFAULT_CONFIG = {
    layout: {
      ...
      playLightMode: "playing", // off | playing (lit while a game is on) | always (also on the idle clock)
      playLightColor: [255, 255, 255],   // base light colour — change then Push config
      playLightStrobe: false,   // optional very gentle pulse on the base colour
